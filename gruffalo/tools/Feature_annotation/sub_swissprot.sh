...
blastp \
  -db db/$SwissDB_Name \
  -query proteins.fa \
  -out swissprot_vSept_2021_10_hits.tbl \
  -evalue 1e-100 \
  -outfmt 6 \
  -num_threads 8 \
  -num_alignments 10
...
$ProgDir/swissprot_parser.py --blast_tbl swissprot_vSept_2021_10_hits.tbl --blast_db_fasta db/"$SwissDB_Name".fasta > swissprot_vSept_2021_tophit_parsed.tbl
