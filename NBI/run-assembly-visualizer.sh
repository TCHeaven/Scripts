...
juicebox=~/git_repos/Scripts/NBI/"juicebox_tools.sh"

lift_input_mnd_script=~/git_repos/Scripts/NBI/lift-input-mnd-to-asm-mnd.awk
lift_input_annotations_script=~/git_repos/Scripts/NBI/lift-input-annotations-to-asm-annotations.awk
